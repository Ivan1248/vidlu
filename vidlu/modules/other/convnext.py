# Code taken from https://github.com/facebookresearch/ConvNeXt
...
class ConvNeXt(ConvNeXtBackbone):
    r""" ConvNeXt
        A PyTorch impl of : `A ConvNet for the 2020s`  -
          https://arxiv.org/pdf/2201.03545.pdf
    Args:
    ...
    def __init__(self, in_chans=3, num_classes=1000,
        ...
        super().__init__(in_chans, num_classes, depths, dims, drop_path_rate,
