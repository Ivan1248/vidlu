# Form https://github.com/chenjun2hao/DDRNet.pytorch
...
def ddrnet23s(num_classes=19, planes=32, spp_planes=128,
              head_planes=64, augment=False, pretrained=False):
    model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, planes=planes,
                       spp_planes=spp_planes, head_planes=head_planes, augment=augment)
    if pretrained:
