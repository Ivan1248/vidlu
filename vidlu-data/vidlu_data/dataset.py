...
from .utils import (to_valid_path, create_file_atomic, time_since_access,
                     Stopwatch, slice_len, query_user, pickle_sizeof,
                     DefaultCompressor)
...
def clean_up_dataset_cache(cache_dir, max_time_since_access: dt.timedelta):
    ...
    for dir in cache_path.iterdir():
        ...
        if file is None or (time_since_access(file) > max_time_since_access):
